...
import com.cmall.provider.mapper.UacUserTokenMapper;
...
import com.cmall.provider.model.enums.UacUserTokenStatusEnum;
import com.cmall.provider.service.OpcRpcService;
import com.cmall.provider.service.UacUserService;
import com.cmall.provider.service.UacUserTokenService;
import com.cmall.security.core.properties.OAuth2ClientProperties;
...
public class UacUserTokenServiceImpl extends BaseService<UacUserToken> implements UacUserTokenService {
	...
	@Value("${cmall.auth.refresh-token-url}")
