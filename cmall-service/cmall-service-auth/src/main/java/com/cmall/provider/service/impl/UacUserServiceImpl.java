...
import com.cmall.core.enums.LogTypeEnum;
import com.cmall.core.support.BaseService;
import com.cmall.core.utils.RequestUtil;
import com.cmall.provider.manager.UserManager;
import com.cmall.provider.mapper.UacActionMapper;
import com.cmall.provider.mapper.UacMenuMapper;
import com.cmall.provider.mapper.UacUserMapper;
import com.cmall.provider.mapper.UacUserMenuMapper;
import com.cmall.provider.model.entity.*;
import com.cmall.provider.model.dto.menu.UserMenuChildrenDto;
import com.cmall.provider.model.dto.menu.UserMenuDto;
import com.cmall.provider.model.dto.user.*;
import com.cmall.provider.model.enums.UacEmailTemplateEnum;
import com.cmall.provider.model.enums.UacUserSourceEnum;
import com.cmall.provider.model.enums.UacUserStatusEnum;
import com.cmall.provider.model.enums.UacUserTypeEnum;
...
import com.cmall.provider.mq.producer.EmailProducer;
import com.cmall.provider.service.*;
import com.cmall.provider.utils.Md5Util;
...
public class UacUserServiceImpl extends BaseService<UacUser> implements UacUserService {
	...
	@Value("${cmall.auth.active-user-url}")
