...
import com.cmall.provider.mapper.PtcPayInfoMapper;
import com.cmall.provider.model.constant.OmcApiConstant;
import com.cmall.provider.model.constant.PtcApiConstant;
...
import com.cmall.provider.model.dto.attachment.OptUploadFileByteInfoReqDto;
...
import com.cmall.provider.service.PtcAlipayService;
...
public class PtcAlipayServiceImpl implements PtcAlipayService {
	...
	@Value("${cmall.alipay.callback.url}")
	private String alipayCallbackUrl;
	@Value("${cmall.alipay.qrCode.pcPath}")
	private String qrCodePcPath;
	@Value("${cmall.alipay.qrCode.qiniuPath}")
	...
	public Wrapper pay(String orderNo, LoginAuthDto loginAuthDto) {
		...
		switch (result.getTradeStatus()) {
			case SUCCESS:
				...
				optUploadFileReqDto.setBucketName("data2-public");
