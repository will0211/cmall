package com.cmall.core.registry;

import com.cmall.config.properties.AliyunProperties;
import com.cmall.config.properties.CmallProperties;
import com.cmall.config.properties.ZookeeperProperties;
import com.cmall.core.generator.IncrementIdGenerator;
import com.cmall.core.registry.base.CoordinatorRegistryCenter;
import com.cmall.core.registry.base.RegisterDto;
import com.cmall.core.registry.zookeeper.ZookeeperRegistryCenter;
...
public final class RegistryCenterFactory {
	 ...
	 * Startup.
	 *
	 * @param cmallProperties the  properties
	 * @param host                the host
	 * @param app                 the app
	 */
	public static void startup(CmallProperties cmallProperties, String host, String app) {
		CoordinatorRegistryCenter coordinatorRegistryCenter = createCoordinatorRegistryCenter(cmallProperties.getZk());
		...
		registerMq(cmallProperties, host, app);
	}

	private static void registerMq(CmallProperties cmallProperties, String host, String app) {
		CoordinatorRegistryCenter coordinatorRegistryCenter = createCoordinatorRegistryCenter(cmallProperties.getZk());
		AliyunProperties.RocketMqProperties rocketMq = cmallProperties.getAliyun().getRocketMq();
