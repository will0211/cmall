...
public class OAuth2FeignAutoConfiguration {
	 ...
	 */
	@Bean("cmallClientCredentialsResourceDetails")
	 ...
	 */
	@Bean
	public RequestInterceptor oauth2FeignRequestInterceptor(@Qualifier("cmallOAuth2RestTemplate") OAuth2RestTemplate oAuth2RestTemplate) {
