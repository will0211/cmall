package com.cmall.base.constant;
...
public class GlobalConstant {
	...
	public static final String ROOT_PREFIX = "cmall";

	public static final int EXCEPTION_CAUSE_MAX_LENGTH = 2048;
	public static final int EXCEPTION_MESSAGE_MAX_LENGTH = 2048;

	public static final String ZK_REGISTRY_SERVICE_ROOT_PATH = "/cmall/registry/service";
	public static final String ZK_REGISTRY_ID_ROOT_PATH = "/cmall/registry/id";
	public static final String ZK_REGISTRY_PRODUCER_ROOT_PATH = "/cmall/registry/producer";
	public static final String ZK_REGISTRY_CONSUMER_ROOT_PATH = "/cmall/registry/consumer";
	public static final String ZK_REGISTRY_SEQ = "/cmall/seq";
	...
	public static final class Sys {
		 ...
		 */
		public static final String DEFAULT_FILE_PATH = "cmall/file/";
