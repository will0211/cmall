...
import com.cmall.provider.service.hystrix.MdcMqMessageApiHystrix;
 ...
 *
 */
@FeignClient(value = "cmall-service-mdc", configuration = OAuth2FeignAutoConfiguration.class, fallback = MdcMqMessageApiHystrix.class)
