...
import com.cmall.provider.model.service.hystrix.UacMqMessageApiHystrix;
 ...
 *
 */
@FeignClient(value = "cmall-provider-uac", configuration = OAuth2FeignAutoConfiguration.class, fallback = UacMqMessageApiHystrix.class)
