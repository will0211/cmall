...
import com.cmall.provider.service.hystrix.OmcCartFeignHystrix;
 ...
 *
 */
@FeignClient(value = "cmall-service-omc", configuration = OAuth2FeignAutoConfiguration.class, fallback = OmcCartFeignHystrix.class)
